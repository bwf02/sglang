...
from sglang.srt.layers.moe.moe_runner.sparse_gemm import SparseGemmRunnerCore
...
class MoeRunner:
    def __init__(
        ...
        elif runner_backend.is_sparse_gemm():
            self.runner_core = SparseGemmRunnerCore(config)
